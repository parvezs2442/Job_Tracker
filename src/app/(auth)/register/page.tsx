    ...
    <main className="min-h-screen w-full flex items-center justify-center px-4 relative overflow-hidden bg-[#09090b]">
      ...
      <div className="w-full max-w-[420px] animate-fade-in z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400 mt-1.5">Get started tracking your applications today</p>
        </div>
        ...
        <div className="bg-[#18181b] border border-zinc-800 rounded-xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-xs font-medium text-zinc-300 mb-1.5 uppercase tracking-wider">
                Full Name
              </label>
            ...
            <div>
              <label htmlFor="password" className="block text-xs font-medium text-zinc-300 mb-1.5 uppercase tracking-wider">
                Password
              </label>
              <div className="relative">
